...
<!--navbar start-->
    ...
    <div class="container d-flex justify-content-center Login_title">
        <h4 class="text-primary">Supervisor Registration</h4>
        </div>
     <form action="Insert" method="post">
        ...
        <div class="form-outline mb-4">
          ...
          <input type="text" id="form2Example1" class="form-control" name="Employee_Name" value="${Employee_Name}" placeholder="Enter name" required/>
        </div>
      
        <!-- Email-id input -->
        <div class="form-outline mb-4">
          <label class="form-label" for="form2Example2" >Email<span style="color:red;font-size: 18px;">*</span></label>
          <input type="email" id="form2Example2" class="form-control"  name="Employee_Email" value="${Employee_Email}" placeholder="Enter email" required/>
        </div>
        ...
        <div class="form-outline mb-4">
            ...
            <input type="number" class="form-control" id="form2Example1" name="Employee_Mobile_No" value="${Employee_Mobile_No}" placeholder="Enter mobile number" required>
        </div>
      ...
      <!-- Address details -->
        <div class="form-outline mb-4">
            ...
            <textarea  id="form2Example1" class="form-control" name="Employee_Address" placeholder="Enter residential address">${Employee_Address }</textarea>
